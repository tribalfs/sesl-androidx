...
class SeslGradientColorSeekBar extends SeekBar {
    ...
    private final int[] mColors = {Color.BLACK, Color.WHITE};
    private final GradientDrawable mProgressDrawable;

    public SeslGradientColorSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        mProgressDrawable = (GradientDrawable) ContextCompat.getDrawable(getContext(), R.drawable.sesl_color_picker_gradient_seekbar_drawable);
        mContext = context;
    ...
    private void initThumb() {
        setThumb(ContextCompat.getDrawable(getContext(), R.drawable.sesl_color_picker_seekbar_cursor));
        setThumbOffset(0);
        setSplitTrack(false);
    }
