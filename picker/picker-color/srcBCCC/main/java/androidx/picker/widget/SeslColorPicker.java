...
public class SeslColorPicker extends LinearLayout {
    ...
    public SeslColorPicker(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
                ...
                if (isContains(widthDp)) {
                    ...
                    if (screenWidth
                        ...
                        final int horizontalPadding =
                                (int) ((screenWidth - opacitySeekbarWidth) / 2.0f);
                        final int paddingTop =
                                mResources.getDimensionPixelSize(R.dimen.sesl_color_picker_dialog_padding_top);
                        final int paddingBottom =
                                mResources.getDimensionPixelSize(R.dimen.sesl_color_picker_dialog_padding_bottom);

                        LinearLayout colorPickerMainContainer =
                                findViewById(R.id.sesl_color_picker_main_content_container);
                        colorPickerMainContainer.setPadding(horizontalPadding, paddingTop,
    ...
    private void initCurrentColorView() {
        ...
        TextView currentColorText =
                (TextView) findViewById(R.id.sesl_color_picker_current_color_text);
        currentColorText.setTextColor(textColor);
        TextView pickedColorText =
                (TextView) findViewById(R.id.sesl_color_picker_picked_color_text);
    ...
    private void initOpacitySeekBar() {
        ...
        mOpacitySeekBar.setOnTouchListener(
                (view, event) -> event.getAction() == MotionEvent.ACTION_DOWN);
