...
public class SeslTimePicker extends FrameLayout {
    ...
    public interface OnEditTextModeChangedListener {
        void onEditTextModeChanged(@NonNull SeslTimePicker view, boolean isEditTextMode);
    }

    public interface OnTimeChangedListener {
        void onTimeChanged(@NonNull SeslTimePicker view, int hourOfDay, int minute);
    }

    public SeslTimePicker(@NonNull Context context) {
        this(context, null);
    }

    public SeslTimePicker(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public SeslTimePicker(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr,
            int defStyleRes) {
