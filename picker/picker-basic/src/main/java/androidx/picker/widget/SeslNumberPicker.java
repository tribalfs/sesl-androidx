...
public class SeslNumberPicker extends LinearLayout {
    ...
    private final NumberPickerDelegate mDelegate;
    ...
    public interface OnEditTextModeChangedListener {
        void onEditTextModeChanged(@NonNull SeslNumberPicker numberPicker, boolean isEditTextMode);
    }
    ...
    public interface OnValueChangeListener {
        void onValueChange(@NonNull SeslNumberPicker spinner, int oldVal, int newVal);
    }
    ...
    public SeslNumberPicker(@NonNull Context context) {
        this(context, null);
    }

    public SeslNumberPicker(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public void setPickerContentDescription(@Nullable String name) {
    ...
    public void setOnEditTextModeChangedListener(@Nullable OnEditTextModeChangedListener onEditTextModeChangedListener) {
    ...
    public void setErrorToastMessage(@NonNull String msg) {
    ...
    public void startAnimation(int delayTime, @Nullable SeslAnimationListener listener) {
    ...
    static class CustomEditText extends EditText {
        ...
        private CharSequence getTextForAccessibility() {
            ...
            if (mPickerContentDescription.isEmpty()) {
                return text;
            }
            if (!TextUtils.isEmpty(text)) {
