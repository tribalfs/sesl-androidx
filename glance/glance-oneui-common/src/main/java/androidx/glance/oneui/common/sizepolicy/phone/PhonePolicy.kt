...
package androidx.glance.oneui.common.sizepolicy.phone
...
abstract class PhonePolicy : SizeRatioPolicy() {
    companion object {
    ...
    object PortraitPolicy : PhonePolicy() {
    ...
    object LandscapePolicy : PhonePolicy() {
        override val hRatioLevel0 = 0.0f
    ...
    object PortraitPolicyWithEasyMode : PhonePolicy() {
        override val hRatioLevel0 = 0.0f
        override val hRatioLevel1 = 0.145f
        override val hRatioLevel2 = 0.36f
        override val hRatioLevel3 = 0.54f
        override val hRatioLevel4 = 1.0f
        override val wRatioLevel0 = 0.0f
    ...
    object LandscapePolicyWithEasyMode : PhonePolicy() {
        override val hRatioLevel0 = 0.0f
