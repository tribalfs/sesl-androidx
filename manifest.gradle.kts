...
extra.apply {
    set(
        "moduleInfo", mapOf(
            ...
            "androidx.core" to listOf("1.17.0-beta01", "1.0.7-sesl8", "rev0", 21, 36),
            "androidx.core-ktx" to listOf("1.17.0-beta01", "1.0.0-sesl8", "rev0", 21, 36),
            ...
            "androidx.appcompat" to listOf("1.7.1", "1.0.18-sesl8", "rev1", 21, 35),
            "androidx.fragment" to listOf("1.8.8", "1.0.5-sesl8", "rev0", 21, 35),
            "androidx.recyclerview" to listOf("1.4.0", "1.0.12-sesl8", "rev0", 21, 35),
            "androidx.preference" to listOf("1.2.1", "1.0.0-sesl8", "rev0", 21, 35),
            ...
            "androidx.picker-basic" to listOf("1.0.7", "1.0.7-sesl8", "rev1", 21, 35),
            "androidx.picker-color" to listOf("1.0.2", "1.0.2-sesl8", "rev1", 21, 35),
