...
extra.apply {
    set(
        "moduleInfo", mapOf(
            ...
            "androidx.core" to listOf("1.16.0", "1.0.16-sesl7", "rev2", 21, 35),
            ...
            "androidx.appcompat" to listOf("1.7.1", "1.0.47000-sesl7", "rev2", 21, 35),
            "androidx.fragment" to listOf("1.8.8", "1.0.9-sesl7", "rev0", 21, 35),
            "androidx.recyclerview" to listOf("1.4.0", "1.0.33-sesl7", "rev4", 21, 35),
            ...
            "androidx.picker-app" to listOf("1.0.21", "1.0.21-sesl7", "rev3", 21, 35),
