...
/**
 * Returns the first component of the color. For instance, when the color model of the color is
 * [android.graphics.ColorSpace.Model.RGB], the first component is "red".
 *
 ...
 * [android.graphics.ColorSpace.Model.RGB], the second component is "green".
 *
 * This method allows to use destructuring declarations when working with colors, for example:
 * ```
 * val (red, green, blue) = myColor
 ...
 * [android.graphics.ColorSpace.Model.RGB], the third component is "blue". = * This method allows to
 * use destructuring declarations when working with colors, for example:
 * ```
 * val (red, green, blue) = myColor
 * ```
 */
 ...
 * [android.graphics.ColorSpace.Model.RGB], the fourth component is "alpha".
 *
 * This method allows to use destructuring declarations when working with colors, for example:
 * ```
 ...
 * [source over][android.graphics.PorterDuff.Mode.SRC_OVER] blending mode. The colors must not be
 * pre-multiplied and the result is a non pre-multiplied color.
 *
 * If the two colors have different color spaces, the color in the right-hand part of the expression
 * is converted to the color space of the color in left-hand part of the expression.
 *
 ...
 * ```
 *
 * @throws IllegalArgumentException if the [color models][android.graphics.Color.getModel] of the
 *   colors do not match
 */
@RequiresApi(26)
@SuppressLint("ClassVerificationFailure")
 ...
 * ```
 */
public inline val @receiver:ColorInt Int.alpha: Int
 ...
 * ```
 */
public inline val @receiver:ColorInt Int.red: Int
 ...
 * ```
 */
public inline val @receiver:ColorInt Int.green: Int
 ...
 * ```
 */
public inline val @receiver:ColorInt Int.blue: Int
    get() = this and 0xff
...
/**
 * Returns the relative luminance of a color int, assuming sRGB encoding. Based on the formula for
...
/**
 * Returns the third component of the color. For instance, when the color model of the color is
 * [android.graphics.ColorSpace.Model.RGB], the third component is "blue".
 *
 * This method allows to use destructuring declarations when working with colors, for example:
 * ```
 * val (red, green, blue, alpha) = myColorLong
...
/**
 * Returns the relative luminance of a color. Based on the formula for relative luminance defined in
...
/**
 * Converts the color int receiver to a color long in the specified color space. This is equivalent
 * to calling:
 * ```
...
/**
 * Converts the color long receiver to a color long in the specified color space. This is equivalent
 * to calling:
 * ```
...
/**
 * Converts the color receiver to a color in the specified color space. This is equivalent to
 * calling:
 * ```
