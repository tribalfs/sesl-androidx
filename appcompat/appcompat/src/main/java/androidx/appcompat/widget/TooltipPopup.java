...
/**
 * (SESL modified) A popup window displaying a text message aligned to a specified view.
 *
 */
...
class TooltipPopup {
    ...
    private int mNavigationBarHeight = 0;//sesl
    ...
    TooltipPopup(@NonNull Context context) {
        ...
        mLayoutParams.flags = WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE
                | WindowManager.LayoutParams.FLAG_WATCH_OUTSIDE_TOUCH;//sesl
    }
    ...
    void show(View anchorView, int anchorX, int anchorY, boolean fromTouch,
        ...
        computePosition(anchorView, anchorX, anchorY, fromTouch, mLayoutParams, false, false);//sesl
    ...
    private void computePosition(View anchorView, int anchorX, int anchorY, boolean fromTouch,
            WindowManager.LayoutParams outParams, boolean isForceBelow,
            boolean isForceActionBarX) {//sesl
        outParams.token = anchorView.getApplicationWindowToken();

        final int offsetX = anchorView.getWidth() / 2;  //sesl
        ...
        outParams.x = mTmpAnchorPos[0] + offsetX - mTmpDisplayFrame.width() / 2;//sesl

        final int spec = View.MeasureSpec.makeMeasureSpec(0, View.MeasureSpec.UNSPECIFIED);
        mContentView.measure(spec, spec);
        final int tooltipWidth = mContentView.getMeasuredWidth();//sesl
