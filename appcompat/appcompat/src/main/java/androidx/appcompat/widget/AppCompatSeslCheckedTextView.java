...
/**
 * Custom view derived from SeslCheckedTextView modified to follow the
 *  padding logic of oneui framework CheckedTextView
 *  @hide
 */
public class AppCompatSeslCheckedTextView extends TextView implements Checkable {
    ...
    public AppCompatSeslCheckedTextView(Context context) {
        this(context, null);
    }

    public AppCompatSeslCheckedTextView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.checkedTextViewStyle);
    }

    public AppCompatSeslCheckedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    @SuppressLint("RestrictedApi")
    public AppCompatSeslCheckedTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link AppCompatSeslCheckedTextView#onSaveInstanceState()}
         */
